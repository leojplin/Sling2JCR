...
var Sling2JCR = (function () {
    ...
    Sling2JCR.prototype.loginSingle = function (server) {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        Request.post({
                            ...
                            _this.logger.info("Logged in for: " + server.host);
                            resolve(server);
    ...
    Sling2JCR.prototype.getNodeStrategy = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var fileName, filePath, jcrPath, pathSegements, shouldDelete, uploadPath, uploadPath, shouldDelete, uploadPath, uploadPath, file, xml, jcr_root;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        if (!(fileName === "_rep_policy.xml"))
                            return [3 /*break*/, 3];
                        uploadPath = pathSegements.slice(0, pathSegements.length).join("/");
                        return [2 /*return*/, {
                                filePath: filePath,
                                uploadPath: uploadPath,
                                rootNode: "rep:policy",
